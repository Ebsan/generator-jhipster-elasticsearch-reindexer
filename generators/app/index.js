  ...
  writing: {
    setUpVars: function() {
      ...
      if (this.clientFramework === "angularX") {
        this.angularXAppName = this.getAngularXAppName
          ? this.getAngularXAppName()
          : config.angularXAppName;
      ...
      jhipsterVar.javaDir = `${jhipsterConstants.SERVER_MAIN_SRC_DIR +
        this.packageFolder}/`;
    ...
    validateVars: function() {
      if (!this.jhipsterVersion) {
        this.log(
          chalk.yellow(
            "WARNING jhipsterVersion is missing in JHipster configuration, defaulting to v2"
          )
        );
      }
      if (!this.applicationType) {
        this.log(
          chalk.yellow(
            "WARNING applicationType is missing in JHipster configuration, using monolith as fallback"
          )
        );
      ...
      if (!this.nativeLanguage) {
        this.log(
          chalk.yellow(
            "WARNING nativeLanguage is missing in JHipster configuration, using english as fallback"
          )
        );
    ...
    writeTemplates: function() {
      if (!this.skipServer) {
        this.template(
          ...
          jhipsterVar.javaDir + "web/rest/ElasticsearchIndexResource.java",
          this,
          {}
        );
        this.template(
          "src/main/java/package/service/_ElasticsearchIndexService.java",
          jhipsterVar.javaDir + "service/ElasticsearchIndexService.java",
          this,
          {}
        );
      ...
      if (!this.skipClient) {
        if (this.clientFramework === "angular1") {
          ...
          if (this.addJavaScriptToIndex) {
            this.addJavaScriptToIndex(
              "app/admin/elasticsearch-reindex/elasticsearch-reindex.controller.js"
            );
            this.addJavaScriptToIndex(
              "app/admin/elasticsearch-reindex/elasticsearch-reindex-dialog.controller.js"
            );
            this.addJavaScriptToIndex(
              "app/admin/elasticsearch-reindex/elasticsearch-reindex-selected-dialog.controller.js"
            );
            if (this.jhipsterMajorVersion > 2) {
              this.addJavaScriptToIndex(
                "app/admin/elasticsearch-reindex/elasticsearch-reindex.state.js"
              );
              this.addJavaScriptToIndex(
                "app/admin/elasticsearch-reindex.service.js"
              );
            } else {
              this.addJavaScriptToIndex(
                "app/admin/elasticsearch-reindex/elasticsearch-reindex.js"
              );
              this.addJavaScriptToIndex(
                "components/admin/elasticsearch-reindex.service.js"
              );
            }
          }
          ...
          if (this.addElementToAdminMenu) {
            ...
            if (this.enableTranslation) {
              this.addAdminElementTranslationKey(
                "elasticsearch-reindex",
          ...
          this.template(
            "src/main/webapp/ts/_index.ts",
            jhipsterVar.webappDir + this.appFolder + "/index.ts",
            this,
            {}
          );
          if (this.addAdminToModule) {
            ...
            this.log(
              chalk.yellow(
                "WARNING the function addAdminToModule is missing, you need to add the missing import in src/main/webapp/app/admin/admin.module.ts:"
              )
            );
            this.log(
    ...
    registering: function() {
      try {
        this.registerModule(
          ...
          "post",
          "app",
          "Generate a service for reindexing all database rows for each of your entities"
        );
      } catch (err) {
        this.log(
          chalk.red.bold("WARN!") +
...
if (
  yeomanGenerator.extend ||
  (yeomanGenerator.Base && yeomanGenerator.Base.extend)
) {
